...
template<typename A, typename B>
inline A tMax(A a, B b)
{
	if(a<b) return b;
	else return a;
}

template<typename Real> Real clamp (const Real& value, const Real& min, const Real& max)
{
...
{ return vec2(tMin(a.n[VX], b.n[VX]), tMin(a.n[VY], b.n[VY])); }

inline vec2 max(const vec2& a, const vec2& b)
{ return vec2(tMax(a.n[VX], b.n[VX]), tMax(a.n[VY], b.n[VY])); }
...
{ return vec3(tMin(a.n[VX], b.n[VX]), tMin(a.n[VY], b.n[VY]), tMin(a.n[VZ],
  b.n[VZ])); }

inline vec3 max(const vec3& a, const vec3& b)
{ return vec3(tMax(a.n[VX], b.n[VX]), tMax(a.n[VY], b.n[VY]), tMax(a.n[VZ],
  b.n[VZ])); }
...
{ return vec4(tMin(a.n[VX], b.n[VX]), tMin(a.n[VY], b.n[VY]), tMin(a.n[VZ],
  b.n[VZ]), tMin(a.n[VW], b.n[VW])); }

inline vec4 max(const vec4& a, const vec4& b)
{ return vec4(tMax(a.n[VX], b.n[VX]), tMax(a.n[VY], b.n[VY]), tMax(a.n[VZ],
  b.n[VZ]), tMax(a.n[VW], b.n[VW])); }
